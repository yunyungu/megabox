...
1100px 미만의 가로폭 해상도에서는 태블릿pc 사용을 기준으로 모바일 사이트 형태로 보여집니다.

추가로 768px 미만의 가로폭 해상도에서는 가로형이 아닌 세로형 모바일 기기에서 보기 편한 UI 형태로 작업하였습니다.

<br>

### :point_right: 1. HEADER / NAV(MENU) 구조
...
<img height="900" alt="desk-nav mouse hover" src="https://github.com/yunyungu/megabox/assets/157336396/13a1fe2e-e105-46b2-9001-88a96fc584d0">

> HEADER의 메인 내비게이션 항목들에 Mouse Hover 했을때에는 각 내비 항목의 서브내비게이션 항목을 보실 수 있습니다.

<br>

<img width="300" alt="desk-nav search" src="https://github.com/yunyungu/megabox/assets/157336396/4b21a32e-b146-47ef-85f8-8253d1a38049">
...
모바일 사이트에서는 더 단순한 형태의 HEADER 구조를 사용하며, 상단에 고정된 상태로 보여집니다.
...
### :point_right: 2. 모바일 사이트 전용 버튼 내비게이션

모바일 사이트에서는 하단에 버튼 내비게이션 기능을 제공합니다.

하단에 고정된 상태로 보여지며, 클릭된 페이지에서 메뉴 버튼의 컬러를 구분하여 보여줍니다.

<img width="900" alt="button nav" src="https://github.com/yunyungu/megabox/assets/157336396/e29c4acb-fd5b-4dfe-865b-4c5de2cd379d">
...
데스크톱 사이트에서는 한 라인에 총 4개 항목의 영화 포스터들이 보여지고, 모바일에서는 아래로 길게 나열하는 형태로 보여집니다.

데스크톱 사이트에서는 포스터 이미지에 mouse hover했을 때, 영화에 대한 상세설명이 보여지지만,

화면이 작은 모바일 기기에서는 제공하지 않습니다.
